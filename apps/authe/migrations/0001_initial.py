# Generated by Django 5.1.3 on 2025-01-20 12:47
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profil_picture', models.CharField(blank=True, max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('players', models.ManyToManyField(related_name='tournament_players', through='authe.PlayerEntry', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddField(
            ...
            name='tournament',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='player_entries', to='authe.tournament'),
        ),
